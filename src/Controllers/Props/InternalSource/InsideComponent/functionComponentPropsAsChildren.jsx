...
export default function FunctionComponentPropsAsChildren(){
    ...
    const shippingAddress = () => {
     ...
     return(
        <React.Fragment>
            ...
            <div className="row">
                <h4 className="text-success">1. Render simple Number, String, Array, Object, another component</h4>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td>{name.firstName + ' ' + name.lastName} is getting {salary}</td>
                            <td>
                                <ul>
